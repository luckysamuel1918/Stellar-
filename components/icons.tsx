...
export const WestcoastLogo = ({ className }: { className?: string }) => (
  <div className={`flex items-center font-bold text-westcoast-dark ${className}`}>
    <svg className="h-8 w-8 mr-2 text-westcoast-blue" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
